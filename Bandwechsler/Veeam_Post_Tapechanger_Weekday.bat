...
IF EXIST %FOLDER%\MONDAY.veeam SET JOBID=INSERT_JOB-ID_HERE
IF EXIST %FOLDER%\TUESDAY.veeam SET JOBID=INSERT_JOB-ID_HERE
IF EXIST %FOLDER%\WEDNESDAY.veeam SET JOBID=INSERT_JOB-ID_HERE
IF EXIST %FOLDER%\THURSDAY.veeam SET JOBID=INSERT_JOB-ID_HERE
IF EXIST %FOLDER%\FRIDAY.veeam SET JOBID=INSERT_JOB-ID_HERE
